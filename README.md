...
- **Shift+Enter**, `Ctrl+J`, or typing `\` before **Enter** to add a newline (Shift+Enter requires a terminal that distinguishes it — most emit `ESC + CR`, the kitty `CSI 13;2u` sequence, or xterm `modifyOtherKeys` `CSI 27;2;13~`)
