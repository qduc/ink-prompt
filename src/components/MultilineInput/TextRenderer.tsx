...
function renderSegment(text: string, isPlaceholder: boolean): React.ReactNode {
  if (isPlaceholder) {
...
export function TextRenderer({
  ...
  const { visualLines, cursorVisualRow, cursorVisualCol } = wrapLines(buffer, cursor, width, images);
